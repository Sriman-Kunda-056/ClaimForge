...
const BADGE = {
  ...
  PARTIAL: 'bg-amber-100 text-amber-700', MANUAL_REVIEW: 'bg-orange-100 text-orange-700',
}

export default function TestCasesSidebar({ onLoad, activeIdx }) {
  return (
    <div className="space-y-2">
      <p className="text-xs font-semibold text-gray-400 uppercase tracking-wide px-1 mb-3">10 Official Test Cases</p>
      {TEST_CASES.map((tc, i) => (
        <button key={tc.case_id} onClick={() => onLoad(i)}
          ...
          <div className="flex items-center justify-between gap-2 mb-1">
            ...
            <span className={`text-xs font-semibold px-2 py-0.5 rounded-full ${BADGE[tc.expected_decision]}`}>
