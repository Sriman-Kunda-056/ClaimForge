...
export const TEST_CASES: TestCase[] = [
  {
    case_id: 'TC001',
    case_name: 'Simple Consultation',
    description: 'Regular consultation for fever, all docs valid',
  ...
  {
    case_id: 'TC002',
    case_name: 'Dental – Partial Approval',
    description: 'Root canal + cosmetic whitening',
  ...
  {
    case_id: 'TC003',
    case_name: 'Limit Exceeded',
    description: 'Claim exceeds per-claim limit of ₹5,000',
  ...
  {
    case_id: 'TC004',
    case_name: 'Missing Prescription',
    description: 'Prescription missing from submission',
    expected_decision: 'REJECTED',
    claim: {
  ...
  {
    case_id: 'TC005',
    case_name: 'Waiting Period',
    description: 'Diabetes treatment within 90-day waiting period',
    expected_decision: 'REJECTED',
    claim: {
  ...
  {
    case_id: 'TC006',
    case_name: 'Alternative Medicine',
    description: 'Ayurvedic Panchakarma within limits',
    expected_decision: 'APPROVED',
    claim: {
  ...
  {
    case_id: 'TC007',
    case_name: 'Pre-auth Required',
    description: 'MRI scan without pre-authorisation',
    expected_decision: 'REJECTED',
    claim: {
  ...
  },
  {
    ...
    description: 'Bariatric / weight loss not covered',
    expected_decision: 'REJECTED',
    claim: {
  ...
  {
    case_id: 'TC010',
    case_name: 'Network Hospital – Cashless',
    description: 'Apollo Hospitals cashless instant approval',
    expected_decision: 'APPROVED',
    claim: {
